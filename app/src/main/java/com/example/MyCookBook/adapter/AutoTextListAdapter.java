...
/**
 * Created by Sonia on 2014-12-21.
 */
public class AutoTextListAdapter extends ArrayAdapter<Product> implements Filterable {
    ...
    public AutoTextListAdapter(Context context, List<Product> products) {
